<%-- 
    Document   : add_logins
    Created on : 5/05/2023, 3:40:56 p. m.
        ...
        <div class="container-xs col-4">
            <form class="" action="/Usuarios" method="POST" >
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="documento"  maxlength="10" required >
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" maxlength="1" name="user_type" >
                </div>
